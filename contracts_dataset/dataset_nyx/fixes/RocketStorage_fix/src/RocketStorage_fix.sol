...
// File: rocketpool-495a51f552b496e1aa61bdbec6cfcb5f882ac38c/contracts/interface/RocketStorageInterface.sol
...
// File: rocketpool-495a51f552b496e1aa61bdbec6cfcb5f882ac38c/contracts/contract/RocketStorage.sol
...
contract RocketStorage is RocketStorageInterface {
    ...
    event DebugInitialised(bool param0, address sender, address origin);
    ...
    function setBool(bytes32 _key, bool _value) onlyLatestRocketNetworkContract override external {
        ...
        emit DebugInitialised(boolStorage[keccak256(abi.encodePacked("contract.storage.initialised"))], msg.sender, tx.origin);
    }
