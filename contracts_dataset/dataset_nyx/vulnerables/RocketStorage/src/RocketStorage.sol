...
// File: rocketpool-44cbf038b97abffa91058cebb2f604220996e641/contracts/interface/RocketStorageInterface.sol
...
// File: rocketpool-44cbf038b97abffa91058cebb2f604220996e641/contracts/contract/RocketStorage.sol
...
contract RocketStorage is RocketStorageInterface {
    ...
    event DebugInitialised(bool param0, address sender);
    ...
    function setBool(bytes32 _key, bool _value) onlyLatestRocketNetworkContract override external {
        ...
        emit DebugInitialised(boolStorage[keccak256(abi.encodePacked("contract.storage.initialised"))], msg.sender);
    }
