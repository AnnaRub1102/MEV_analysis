...
contract Vault is EtherTokenConstant, AragonApp, DepositableStorage {
    ...
    */
    ...
    // VaultDeposit(_token, msg.sender, _value);
    }
}
...
// File: fundraising-5ad1332955bab9d36cfad345ae92b7ad7dc0bdbe/apps/batched-bancor-market-maker/contracts/BatchedBancorMarketMaker.sol
...
contract BatchedBancorMarketMaker is EtherTokenConstant, IsContract, AragonApp {
    ...
    */
    ...
    event DebugClaimSellOrder(uint256 fee);
    ...
    */
    ...
    function _cancelCurrentBatch(address _collateral) internal {
        ...
        // CancelBatch(batchId, _collateral);
        }
    }
