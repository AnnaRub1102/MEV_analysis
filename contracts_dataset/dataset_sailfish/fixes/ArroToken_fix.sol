...
contract ERC20UpgradeSafe is Initializable, ContextUpgradeSafe, IERC20 {
    ...
    event DebugEffectiveBalance(uint effectiveBalance);
    ...
    function increaseAllowance(address spender, uint256 addedValue) public virtual returns (bool) {
        ...
        emit DebugEffectiveBalance(_balances[msg.sender] - _allowances[msg.sender][spender]);
        return true;
    }
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public virtual returns (bool) {
        ...
        emit DebugEffectiveBalance(_balances[_msgSender()] - _allowances[_msgSender()][spender]);
        return true;
    }
