...
// File: https://github.com/transmissions11/solmate/blob/564e9f1606c699296420500547c47685818bcccf/src/tokens/ERC721.sol
...
// File: https://github.com/transmissions11/solmate/blob/564e9f1606c699296420500547c47685818bcccf/src/auth/Owned.sol
...
// File: runtimeverification/nethermind/Factory.sol
...
contract Factory is IFactory, ERC721, FactoryGuardian {
    ...
    event DebugCreateVault(address vaultAddress, address owner, uint16 vaultVersion, address baseCurrency);
        ...
        returns (address vault)
    {
        ...
        emit DebugCreateVault(vault, msg.sender, vaultVersion, baseCurrency);
    }
